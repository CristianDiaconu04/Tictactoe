...
public class Board extends JPanel
{
  ...
  private static final ImageIcon DEFAULT_IMAGE = new ImageIcon("x.png");
  private static final ImageIcon[] IMAGES = new ImageIcon[2];
  
  private static final String[] IMAGE_NAMES = {"x", "o"};
  ...
  public Board (int rows, int cols)
  {
    ...
    IMAGES[0]= new ImageIcon("x.png");
    IMAGES[1]= new ImageIcon("o.png");
   ...
   */
  private ImageIcon convertImageIcon( String theImage )
  {
    for( int i=0; i<COLOUR_NAMES.length; i++ )
    {
      if( IMAGE_NAMES[i].equalsIgnoreCase( theImage ) )
        return IMAGES[i];
    }
   ...
   */
  public void drawLines(int row1, int col1, int row2, int col2)
  {
